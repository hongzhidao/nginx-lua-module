...
ngx_int_t ngx_http_lua_resume(ngx_http_request_t *r, ngx_str_t *name, ngx_event_t *wake);
ngx_int_t ngx_http_lua_eval(ngx_http_request_t *r, ngx_str_t *name, ngx_str_t *result);
ngx_int_t ngx_http_lua_yield(ngx_http_request_t *r);
